...
local function requesturl(url, bypass) 
    ...
    local repourl = bypass and "https://raw.githubusercontent.com/Maanaaaa/" or "https://raw.githubusercontent.com/Maanaaaa/Future/main/"
...
local SignalLib = loadstring(requesturl("Future/lib/SignalLib.lua", false))()
...
GuiLibrary["CreateNotification"] = function(content)
    if GuiLibrary["AllowNotifications"] then
        if PLAYERS.LocalPlayer.PlayerGui:FindFirstChild("Chat") then
